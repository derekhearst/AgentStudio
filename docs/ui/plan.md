...
Status: active (Wave 0 gate satisfied; Phases 2–7 continue through Wave 5)
...
- Phase 4.1 unified action card: [src/lib/ui/ActionCard.svelte](../../src/lib/ui/ActionCard.svelte)

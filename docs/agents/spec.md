...
`/agents/[id]` — agent detail with tabs for: Identity (markdown editor), Config, Hooks, Skills, Runs. Pause / Resume sits in the page header for custom agents; built-ins and evaluators show a label instead.

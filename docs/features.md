...
- Chronological event stream: agent action, chat started, review and skill events
...
- Automation and tool approval configuration
...
- Required extensions are installed automatically: `pgcrypto` for UUID defaults

...
11. [ ] Task lifecycle alignment with runtime/runs
    ...
    - Phases 3 (task runner worker), 4 (kanban UI), 5 (retries + DAG) still pending. The runner is the natural next step — it would pick `pending` child tasks and create runs against them.

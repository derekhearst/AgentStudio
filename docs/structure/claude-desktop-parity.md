...
| Preview a file or a website in a side panel | **even** (#29) | right-rail Preview tab: markdown, highlighted code, images, PDFs, directory listing, sandboxed URL iframe; selection persists per conversation | artifact + document preview |

...
| #8 | Delete dead engine code | **as filed** — mostly done | stream-prep helpers, in-house compaction, `search_tools` and `run_code` (#69) deleted; the old loop stays while automations, monitors and CI fix runs call it |

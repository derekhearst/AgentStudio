...
- On a wide screen (1280px and up) `/automations` shows the list on the left and the creation form in a column on the right that stays in view while the list scrolls. On narrower screens the form sits below the list. Creating, pausing or deleting an automation updates the list straight away.

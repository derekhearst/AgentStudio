...
<div class="dropdown dropdown-end dropdown-hover">
	...
	<div tabindex="-1" class="dropdown-content z-[100] w-72 px-2 pt-2">
		<div class="card card-compact bg-base-100 border-base-300 rounded-xl border p-3 text-sm shadow-xl">
